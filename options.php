...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => '站点图标',
		'desc' => '"站点图标"(16*16)，此功能只用于http，如果是https会提示"此网页正试图从未经验证的来源加载脚本"，先remove再在网站根目录上传图片命名为favicon.ico即可',
		'id' => 'icon',
		'type' => 'upload');
	$options[] = array(
		'name' => '站点大LOGO',
	...
	$options[] = array(
		'name' => '压缩html代码',
		'desc' => '选中此项，右键页面源代码发现被压缩去掉了空行，注意：并没有压缩css和js',
		'id' => 'compress_html',
		'std' => '0',//std代表默认填入的值0表示未选中该复选框
		'type' => 'checkbox');	
    $options[] = array(
        'name' => '页面底部友情链接ID',
	...
	$options[] = array(
		'name' => '是否启用文章页右侧浮动广告',
		'desc' => '选择是否启用文章页右侧浮动广告（建议宽度350px以内）（预留功能，未开发）',
